...
export const productDetail = 
  {
    "job_name": "Test Database Cho Duc Trong",
    "categoryDetail": "Database",
    "job_post_detail": {
      "profile_name": "Nguyen Minh Thuan",
      "description": "a base entity is a TypeScript class that represents the basic structure of a database entity",
      "FAQ": "No refunds",
      "packages": [
        {
          "package_id": 0,
...
export const ImgProduct = {
  0: './accets/products/1.jpg',
  1: './accets/products/2.jpg',
  2: './accets/products/3.jpg',
  3: './accets/products/4.jpg',
  4: './accets/products/5.jpg',
  5: './accets/products/6.jpg',
  6: './accets/products/7.jpg',
}